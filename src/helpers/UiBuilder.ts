...
>(
	prop: T,
	base: B,
): prop is Exclude<T, null> & keyof B & string => {
 ...
 */
const resolve = <T extends MaybeLazy<any>>(val: T): string =>
...
const componentApi =
	<TBase extends Record<string, any>, TGlobalOpt extends UiBuilderOptions>(
		el: HTMLElement,
		base: TBase,
		global_opt: TGlobalOpt,
		log_level: LogLevel,
