import { CssCursor, CssDisplay, CssPosition, CssSizing, EmptyObject } from "inferred-types";
import { ObsidianFoldOptions } from "./ObsidianCallouts";

export type UserStyleOptions = {
