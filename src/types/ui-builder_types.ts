...
>(base: TBase, prop: TProp) => Callback<TArgs,TReturn>;
...
>(base: TBase, prop: TProp, opt?: TOpt, change_cb?: ChangeCallback) => <
  TComponent extends AnyComponent,
>(component_cb: ComponentCallback<TComponent>) => void;
...
> {
  ...
  >(prop: TIterator, cb: Callback<[TContainer],Setting> ) => Setting[];
}
