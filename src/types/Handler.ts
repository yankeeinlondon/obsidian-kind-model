import { AfterFirst, CsvToStrUnion, CsvToTuple, CsvToTupleStr, Dictionary, ExpandDictionary, First } from "inferred-types";
import { Component, MarkdownPostProcessor, MarkdownPostProcessorContext } from "obsidian";
import KindModelPlugin from "~/main";
import { PageInfoBlock } from "./Page";

/**
 * A handler's query parameters definition.
 */
export type QueryDefinition<
	S extends readonly ScalarDefn[] = ScalarDefn[],
	O extends Record<string,TypeToken> = Record<string,TypeToken>
> = {
	scalar: ScalarDefn[];
	options: OptionsDefn; 
}
...
export type OptionParams<
	T extends Record<string, TypeToken> | undefined
> = T extends undefined 
? {}
 ...
 * is fired.
 */
export type ObsidianCodeblockEvent = {
	source: string, 
	el: HTMLElement, 
...
export type Handler<
	...
	TOpt extends Dictionary
> = (
	event: HandlerEvent<THandler, TScalar,TOpt>
) => Promise<void>;
